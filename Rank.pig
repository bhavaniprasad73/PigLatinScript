...
result = FOREACH z GENERATE rank_1::rank_sorted, rank_1::group,rank_1::count1, (rank_1::count1/ontime_count::count2);    /* This will generate the portions of the on-time flights by ranked carrier to the total on-time flights */
STORE result INTO 's3://piglatinscript/Output/RankResult';                                                  /* This will store the results to S3 Bucket in the Output folder witht the file name RankResult  */
